  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 pointer-events-none w-auto max-w-[96vw]">
        <nav className="pointer-events-auto relative flex items-center gap-1 sm:gap-3 px-2 sm:px-5 py-1.5 sm:py-2.5 rounded-[22px] bg-[#070709] border-t-2 border-emerald-500/80 border-x border-b border-white/[0.08] shadow-[0_20px_60px_rgba(0,0,0,0.9),0_-3px_15px_rgba(16,185,129,0.35)] backdrop-blur-3xl">
          {/* Projects Link */}
          <a
            href="#projects"
            className="px-2 sm:px-5 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-base font-title font-bold text-white hover:text-purple-300 transition-colors whitespace-nowrap"
          >
            Projects
          </a>
          ...
          >
            <button
              ...
              className="px-2 sm:px-5 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-base font-title font-bold text-white hover:text-purple-300 transition-colors whitespace-nowrap cursor-pointer"
          ...
          <div className="relative group inline-flex rounded-2xl p-[1.5px] overflow-hidden shadow-[0_4px_25px_rgba(109,40,217,0.5)] hover:shadow-[0_4px_35px_rgba(109,40,217,0.7)] transition-shadow">
            ...
            >
              ...
              <span className="relative z-10 tracking-tight hidden sm:inline">Start a Project</span>
          ...
          >
            <button
              ...
              className="px-2 sm:px-5 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-base font-title font-bold text-white hover:text-purple-300 transition-colors whitespace-nowrap flex items-center gap-1 cursor-pointer"
            >
              <span>More</span>
              <ChevronUp className="w-3.5 h-3.5 text-zinc-400 hidden sm:block" />
            </button>
