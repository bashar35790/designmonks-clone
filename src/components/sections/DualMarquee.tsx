...
const ROW_1_LOGOS = [
  ...
  { src: "/images/trustedbrands/6885eef1a76e2babd6efc174_Logo_Buttercup_mono.svg", name: "Buttercup" },
  { src: "/images/trustedbrands/6885ef0413f8918ac5356de1_Logo_carbobon_mono.svg", name: "Carbon" },
  { src: "/images/trustedbrands/6885ef13617c539ba8a284f4_Logo_carnesia_mono.svg", name: "Carnesia" },
  { src: "/images/trustedbrands/6885ef283a1bcb89be6747e7_Logo_compaies_mono.svg", name: "Companies" },
  { src: "/images/trustedbrands/6885ef3df74b709059457346_Logo_cpg_mono.svg", name: "CPG" },
...
const ROW_2_LOGOS = [
  ...
  { src: "/images/trustedbrands/6885f06558e5a5df0fbefdde_Logo_khanit_mono.svg", name: "Khan IT" },
  { src: "/images/trustedbrands/6885f091d389d8df99129c17_Logo_leklub_mono.svg", name: "Le Klub" },
  { src: "/images/trustedbrands/6885f0a19297eaa439b36a54_Logo_lendiview_mono.svg", name: "Lendiview" },
  ...
  { src: "/images/trustedbrands/6885f13ec2ad5470f81a0156_Logo_ontik_mono.svg", name: "Ontik" },
...
const ROW_3_LOGOS = [
  ...
  { src: "/images/trustedbrands/6885f17caf72390465b4e033_Logo_PF_mono.svg", name: "Property Finder" },
  ...
  { src: "/images/trustedbrands/688656b4cb56ce5a1e817819_Logo_Relaxy_mono.svg", name: "Relaxy" },
];
...
const ROW_4_LOGOS = [
  ...
  { src: "/images/trustedbrands/69720678ee0f40386f6b4992_Logo_Fraus_mono.svg", name: "Fraus" },
  { src: "/images/trustedbrands/699edc87359d20b3995f03cc_Logo_FMS_ mono (1).svg", name: "FMS" },
  { src: "/images/trustedbrands/69e8da7044354a424b483801_Logo_Salesgo_ mono.svg", name: "Salesgo" },
  { src: "/images/trustedbrands/6a2a85c1739fe7aab067997f_Logo_Externalit_ mono.svg", name: "Externalit" },
...
export function DualMarquee() {
  const renderLogo = (item: { src: string; name: string }, idx: number) => (
    <div
      key={idx}
      className="flex items-center justify-center h-12 sm:h-14 px-4 sm:px-6 flex-shrink-0 opacity-70 hover:opacity-100 transition-opacity duration-300"
    >
      <div className="relative h-6 sm:h-8 w-28 sm:w-36 flex items-center justify-center">
        <Image
          src={item.src}
          alt={item.name}
          fill
          className="object-contain filter grayscale brightness-50 contrast-125"
        />
      </div>
    </div>
  );
  ...
  return (
    <section className="relative -mt-8 sm:-mt-12 pt-16 pb-20 bg-white text-zinc-900 rounded-t-[36px] sm:rounded-t-[60px] md:rounded-t-[80px] shadow-[0_-20px_50px_rgba(0,0,0,0.1)] border-t border-zinc-200/60 z-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 text-center mb-12">
        <h3 className="font-title text-xl sm:text-2xl md:text-3xl font-bold text-zinc-900 tracking-tight">
          Trusted by 200+ of the world&apos;s top brands
        </h3>
      </div>

      {/* 4 Continuous Marquee Rows with 60 Total Logos */}
      <div className="space-y-4 sm:space-y-6">
        {/* Row 1: Left */}
        <Marquee direction="left" duration="40s" pauseOnHover={false} repeat={2}>
          {ROW_1_LOGOS.map(renderLogo)}
        </Marquee>

        {/* Row 2: Right */}
        <Marquee direction="right" duration="40s" pauseOnHover={false} repeat={2}>
